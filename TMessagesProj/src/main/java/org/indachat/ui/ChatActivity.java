...
import org.indachat.messenger.BuildConfig;
...
import org.indachat.messenger.Emoji;
import org.indachat.messenger.EmojiSuggestion;
...
import org.indachat.messenger.SecretChatHelper;
...
import org.indachat.messenger.VideoEditedInfo;
import org.indachat.messenger.browser.Browser;
import org.indachat.messenger.support.SparseLongArray;
import org.indachat.messenger.support.widget.GridLayoutManager;
import org.indachat.messenger.support.widget.GridLayoutManagerFixed;
import org.indachat.messenger.support.widget.LinearLayoutManager;
import org.indachat.messenger.support.widget.LinearSmoothScrollerMiddle;
...
import org.indachat.ui.ActionBar.BackDrawable;
import org.indachat.ui.ActionBar.BottomSheet;
import org.indachat.ui.ActionBar.SimpleTextView;
import org.indachat.ui.ActionBar.ThemeDescription;
import org.indachat.ui.Adapters.MentionsAdapter;
import org.indachat.ui.Adapters.StickersAdapter;
import org.indachat.ui.Cells.BotSwitchCell;
import org.indachat.ui.Cells.ChatActionCell;
import org.indachat.ui.Cells.ChatLoadingCell;
...
import org.indachat.ui.Cells.ChatMessageCell;
import org.indachat.ui.Cells.ChatUnreadCell;
import org.indachat.ui.Cells.CheckBoxCell;
import org.indachat.ui.Cells.ContextLinkCell;
import org.indachat.ui.Cells.MentionCell;
import org.indachat.ui.Cells.StickerCell;
...
import org.indachat.ui.Cells.BotHelpCell;
import org.indachat.ui.Components.ChatActivityEnterView;
import org.indachat.messenger.ImageReceiver;
import org.indachat.ui.Components.ChatAttachAlert;
import org.indachat.ui.Components.ChatAvatarContainer;
import org.indachat.ui.Components.ChatBigEmptyView;
import org.indachat.ui.Components.CombinedDrawable;
import org.indachat.ui.Components.CorrectlyMeasuringTextView;
import org.indachat.ui.Components.EmbedBottomSheet;
import org.indachat.ui.Components.EmojiView;
import org.indachat.ui.Components.ExtendedGridLayoutManager;
import org.indachat.ui.Components.FragmentContextView;
import org.indachat.ui.Components.InstantCameraView;
import org.indachat.ui.Components.LayoutHelper;
import org.indachat.ui.Components.NumberTextView;
import org.indachat.ui.Components.PipRoundVideoView;
import org.indachat.ui.Components.RadialProgressView;
import org.indachat.ui.Components.RecyclerListView;
import org.indachat.ui.Components.ShareAlert;
import org.indachat.ui.Components.Size;
...
import org.indachat.ui.Components.TypefaceSpan;
import org.indachat.ui.Components.URLSpanBotCommand;
import org.indachat.ui.Components.URLSpanMono;
import org.indachat.ui.Components.URLSpanNoUnderline;
import org.indachat.ui.Components.URLSpanReplacement;
import org.indachat.ui.Components.URLSpanUserMention;
...
public class ChatActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, DialogsActivity.DialogsActivityDelegate, LocationActivity.LocationActivityDelegate {
    ...
    private final static int to_post = 55;
    ...
    public View createView(Context context) {
        ...
        if (currentEncryptedChat == null) {
            actionModeViews.add(actionMode.addItemWithWidth(to_post, R.drawable.ic_to_post, AndroidUtilities.dp(54)));
        ...
        actionMode.getItem(to_post).setVisibility(/*canEditMessagesCount == 1 && */selectedMessagesIds[0].size() + selectedMessagesIds[1].size() == 1 ? View.VISIBLE : View.GONE);
    ...
    private void addToSelectedMessages(MessageObject messageObject, boolean outside, boolean last) {
        ...
        if (last && actionBar.isActionModeShowed()) {
            ...
            if (selectedCount == 0) {
                ...
                ActionBarMenuItem toPostItem = actionBar.createActionMode().getItem(to_post);
                ...
                if (toPostItem != null) {
                    if (selectedMessagesIds[0].valueAt(0).botButtonsLayout != null) {
                        toPostItem.setVisibility(View.GONE);
                    } else {
                        toPostItem.setVisibility(/*canEditMessagesCount == 1 && */selectedMessagesIds[0].size() + selectedMessagesIds[1].size() == 1 ? View.VISIBLE : View.GONE);
                    }
                }
                    ...
                    if ((index = animatingMessageObjects.indexOf(message)) != -1) {
                        ...
                        messageCell.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
                            ...
                            public boolean onPreDraw() {
                                ...
                                org.indachat.ui.Components.Rect rect = instantCameraView.getCameraRect();
