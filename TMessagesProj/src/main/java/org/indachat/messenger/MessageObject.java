...
import org.indachat.tgnet.SerializedData;
...
import org.indachat.ui.Components.URLSpanBrowser;
import org.indachat.ui.Components.URLSpanMono;
import org.indachat.ui.Components.URLSpanNoUnderline;
import org.indachat.ui.Components.URLSpanNoUnderlineBold;
    ...
    public MessageObject(int accountNum, TLRPC.Message message, AbstractMap<Integer, TLRPC.User> users, AbstractMap<Integer, TLRPC.Chat> chats, SparseArray<TLRPC.User> sUsers, SparseArray<TLRPC.Chat> sChats, boolean generateLayout, long eid) {
        ...
        if (message instanceof TLRPC.TL_messageService) {
            ...
            if (message.media instanceof TLRPC.TL_messageMediaPhoto) {
                ...
                messageText = LocaleController.getString("UnsupportedMedia", R.string.UnsupportedMedia).replace("https://indachat.org/update","https://github.com/Telegram-FOSS-Team/Telegram-FOSS/blob/master/Update.md");
