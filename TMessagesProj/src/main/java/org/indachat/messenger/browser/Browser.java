...
package org.indachat.messenger.browser;
...
import org.indachat.messenger.CustomTabsCopyReceiver;
...
import org.indachat.messenger.ShareBroadcastReceiver;
import org.indachat.messenger.SharedConfig;
import org.indachat.messenger.UserConfig;
import org.indachat.messenger.support.customtabs.CustomTabsCallback;
import org.indachat.messenger.support.customtabs.CustomTabsClient;
import org.indachat.messenger.support.customtabs.CustomTabsIntent;
import org.indachat.messenger.support.customtabs.CustomTabsServiceConnection;
import org.indachat.messenger.support.customtabs.CustomTabsSession;
import org.indachat.messenger.support.customtabsclient.shared.CustomTabsHelper;
import org.indachat.messenger.support.customtabsclient.shared.ServiceConnection;
import org.indachat.messenger.support.customtabsclient.shared.ServiceConnectionCallback;
...
public class Browser {
    ...
    public static boolean isInternalUri(Uri uri, boolean forceBrowser[]) {
        ...
        } else if ("telegram.me".equals(host) || "z-ct.co".equals(host) || "telesco.pe".equals(host)) {
            String path = uri.getPath();
            if (path != null && path.length() > 1) {
                path = path.substring(1).toLowerCase();
                if (path.equals("iv")) {
