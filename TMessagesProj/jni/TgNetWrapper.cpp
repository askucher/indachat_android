...
static const char *FileLoadOperationClassPathName = "org/indachat/tgnet/FileLoadOperation";
...
static const char *NativeByteBufferClassPathName = "org/indachat/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "org/indachat/tgnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_sendRequest", "(IJLorg/indachat/tgnet/RequestDelegateInternal;Lorg/indachat/tgnet/QuickAckDelegate;Lorg/indachat/tgnet/WriteToSocketDelegate;IIIZI)V", (void *) sendRequest},
        ...
        {"native_checkProxy", "(ILjava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Lorg/indachat/tgnet/RequestTimeDelegate;)J", (void *) checkProxy}
};
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestDelegateInternal = (jclass) env->NewGlobalRef(env->FindClass("org/indachat/tgnet/RequestDelegateInternal"));
    ...
    jclass_RequestTimeDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/indachat/tgnet/RequestTimeDelegate"));
    ...
    jclass_QuickAckDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/indachat/tgnet/QuickAckDelegate"));
    if (jclass_RequestDelegateInternal == 0) {
        return JNI_FALSE;
    }
    ...
    jclass_WriteToSocketDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/indachat/tgnet/WriteToSocketDelegate"));
    ...
    jclass_FileLoadOperationDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/indachat/tgnet/FileLoadOperationDelegate"));
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("org/indachat/tgnet/ConnectionsManager"));
