...
#define FFMPEG_CONFIGURATION "--nm=/Users/kostyapogromskiy/Projects/Telegram-FOSS/TMessagesProj/jni/ffmpeg/toolchain-android/bin/i686-linux-android-nm --ar=/Users/kostyapogromskiy/Projects/Telegram-FOSS/TMessagesProj/jni/ffmpeg/toolchain-android/bin/i686-linux-android-ar --as=/Users/kostyapogromskiy/Projects/Telegram-FOSS/TMessagesProj/jni/ffmpeg/toolchain-android/bin/i686-linux-android-gcc --strip=/Users/kostyapogromskiy/Projects/Telegram-FOSS/TMessagesProj/jni/ffmpeg/toolchain-android/bin/i686-linux-android-strip --cc=/Users/kostyapogromskiy/Projects/Telegram-FOSS/TMessagesProj/jni/ffmpeg/toolchain-android/bin/i686-linux-android-clang --cxx=/Users/kostyapogromskiy/Projects/Telegram-FOSS/TMessagesProj/jni/ffmpeg/toolchain-android/bin/i686-linux-android-clang++ --enable-stripping --arch=x86 --target-os=linux --enable-cross-compile --x86asmexe=/Users/kostyapogromskiy/Downloads/android-ndk-r16b/prebuilt/darwin-x86_64/bin/yasm --prefix=./build/i686 --enable-pic --disable-shared --enable-static --enable-asm --enable-inline-asm --enable-x86asm --cross-prefix=/Users/kostyapogromskiy/Projects/Telegram-FOSS/TMessagesProj/jni/ffmpeg/toolchain-android/bin/i686-linux-android- --sysroot=/Users/kostyapogromskiy/Projects/Telegram-FOSS/TMessagesProj/jni/ffmpeg/toolchain-android/sysroot --extra-cflags='-Wl,-Bsymbolic -Os -DCONFIG_LINUX_PERF=0 -DANDROID -march=i686 -fPIE -pie --static -fPIC' --extra-ldflags='-Wl,-Bsymbolic -Wl,-rpath-link=/Users/kostyapogromskiy/Downloads/android-ndk-r16b/platforms/android-16/arch-x86/usr/lib -L/Users/kostyapogromskiy/Downloads/android-ndk-r16b/platforms/android-16/arch-x86/usr/lib -nostdlib -lc -lm -ldl -fPIC' --enable-version3 --enable-gpl --disable-linux-perf --disable-doc --disable-htmlpages --disable-avx --disable-everything --disable-network --disable-zlib --disable-avfilter --disable-avdevice --disable-postproc --disable-debug --disable-programs --disable-network --disable-ffplay --disable-ffprobe --disable-swscale --disable-postproc --disable-avdevice --enable-runtime-cpudetect --enable-pthreads --enable-avresample --enable-protocol=file --enable-decoder=h264 --enable-decoder=mpeg4 --enable-decoder=gif --enable-decoder=alac --enable-demuxer=mov --enable-demuxer=gif --enable-hwaccels --disable-x86asm --disable-inline-asm --disable-asm"
#define FFMPEG_LICENSE "GPL version 3 or later"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "./build/i686/share/ffmpeg"
#define AVCONV_DATADIR "./build/i686/share/ffmpeg"
#define CC_IDENT "Android clang version 5.0.300080 (based on LLVM 5.0.300080)"
